...
{ 												
  ...
  RCC_AHB1PeriphClockCmd(Port_USART_TX_GPIO_CLK | Port_USART_RX_GPIO_CLK,ENABLE);
  RCC_APB2PeriphClockCmd(Port_USART_CLK,ENABLE);
  GPIO_PinAFConfig(Port_USART_TX_GPIO_PORT, Port_USART_TX_SOURCE, Port_USART_TX_AF);
  GPIO_PinAFConfig(Port_USART_RX_GPIO_PORT, Port_USART_RX_SOURCE, Port_USART_RX_AF);
  //Port_USART_TX -> PA9 , Port_USART_RX -PA10  
  ...
  USART_Init(Port_USART, &USART_InitStructure);	
...
{ 												
  ...
  //RCC_APB2PeriphClockCmd(Port_USART_CLK,ENABLE);RCC_APB1Periph_UART4 
